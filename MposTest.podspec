...
Pod::Spec.new do |s|
  s.name             = 'MposTest'
  s.version          = '0.1.0'
  s.summary          = 'A short description of MposTest.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/<GITHUB_USERNAME>/MposTest'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'MposTest' => 'alexandre.soler@lyra-network.com' }
  s.source           = { :git => 'https://github.com/<GITHUB_USERNAME>/MposTest.git', :tag => s.version.to_s }
